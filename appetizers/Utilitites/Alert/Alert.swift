...
struct AlertContext {
    ...
    static let userSaveSuccess = AlertItem(title: Text("Profile Saved"), message: Text("User Data saved successfully"), dimissButton: .default(Text("OK")))
    static let userDataFailure = AlertItem(title: Text("Data Failure"), message: Text("User Data Failed"), dimissButton: .default(Text("OK")))
}
